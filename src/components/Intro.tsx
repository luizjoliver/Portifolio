    ...
    id="home" ref={ref}>
        ...
        transition={{delay:0.25}}>
            ...
            onClick={() =>{
               ...
               <a href="https://drive.google.com/file/d/1-osR1Kbk3hcHUgpHC0Fk-cZM86zd7Dxy/view?usp=sharing"  target="_blank" download className="group bg-white px-7 py-3 flex 
